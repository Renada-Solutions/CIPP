...
| Link primary column to record page        | When enabled, the name identifying each table row links straight to that record's page in CIPP, so you do not have to open the row's actions menu first. Off by default.                                                                                                                                                                                                                      |
